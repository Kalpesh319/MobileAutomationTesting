...
cap.setCapability("deviceName", " OPPO CPH2251");
cap.setCapability("udid","NFNZN74HJ7DQCIOB");
...
driver.findElement(By.id("com.androidsample.generalstore:id/nameField")).sendKeys("shehnaz hussain");
Thread.sleep(2000);
...
Files.copy(f, new File("C:\\Kalpesh_selenium\\screenshot\\general screenshot"));
Thread.sleep(2000);
